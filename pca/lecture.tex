...
\begin{frame}{A Simple 2D Example}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{figures/slide06_elliptical_data.png}
	\end{center}
...
\begin{frame}{Visual: First Principal Component}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{figures/slide09_first_pc.png}
	\end{center}
...
\begin{frame}{Visual: Second Principal Component}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{figures/slide10_both_pcs.png}
	\end{center}
...
\begin{frame}{Projection Intuition}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{figures/slide11_projection.png}
	\end{center}
...
\begin{frame}{The Projection Operation}
	\begin{center}
		\includegraphics[width=0.55\textwidth]{figures/slide25_projection_3d.png}
	\end{center}
\end{frame}
...
\begin{frame}{Geometric Interpretation}
	\begin{center}
		\includegraphics[width=0.9\textwidth]{figures/slide30_orthogonal_decomp.png}
	\end{center}
\end{frame}
...
\begin{frame}{Scree Plot}
	\begin{center}
		\includegraphics[width=0.70\textwidth]{figures/slide34_scree_plot.png}
	\end{center}
...
\begin{frame}{Cumulative Variance Explained}
	\begin{center}
		\includegraphics[width=0.60\textwidth]{figures/slide35_cumulative_variance.png}
	\end{center}
...
\begin{frame}{Example: Original High-Dimensional Data}
	\begin{center}
		\includegraphics[width=0.63\textwidth]{figures/slide38_iris_pairs.png}
	\end{center}

	\vspace{0.3em}
	Feature histograms colored by species reveal
	distinct distributions, especially for petal dimensions.
\end{frame}

\begin{frame}{Covariance Structure}
	\begin{center}
		\includegraphics[width=0.50\textwidth]{figures/slide39_covariance.png}
	\end{center}
...
\begin{frame}{Eigenvalue Spectrum}
	\begin{center}
		\includegraphics[width=0.60\textwidth]{figures/slide40_eigenvalues.png}
	\end{center}

	\vspace{0.5em}
	First two components capture $\sim$98\% of variance---excellent
	for 2D visualization!
\end{frame}

\begin{frame}{First Two Principal Components}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{figures/slide41_pc_projection.png}
	\end{center}
...
\begin{frame}{Reconstruction Quality}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{figures/slide42_reconstruction.png}
	\end{center}

	\vspace{0.5em}
	With 2 components (98\% variance), reconstruction is excellent.
...
\begin{frame}{Interpretation of Components}
	...
	The first principal component $\vect{u}_1$ has loadings:
	\[
		\vect{u}_1 = [0.362, -0.082, 0.857, 0.359]
	\]
	for sepal length, sepal width, petal length, and petal width respectively.

	\pause

	\textbf{Interpretation:} PC1 is dominated by petal dimensions
	\begin{itemize}
		\item Very large positive weight on petal length (0.857)
		\item Moderate positive weights on petal width and sepal length
		\item Near-zero weight on sepal width (-0.082)
		\item PC1 primarily captures variation in petal size
	\end{itemize}
...
\begin{frame}{When PCA Struggles}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{figures/slide45_pca_failures.png}
	\end{center}

	\vspace{0.3em}
	PCA fails when data has nonlinear structure or when
	discriminative information lies in low-variance directions.
\end{frame}
...
\begin{frame}[fragile,shrink=10]{Scikit-learn Example: Basic Usage}
	\footnotesize
	\begin{lstlisting}
import numpy as np
...
\begin{frame}[fragile,shrink=20]{Analyzing Results}
	\footnotesize
	\begin{lstlisting}
...
\begin{frame}[fragile,shrink=25]{Choosing Number of Components}
	\footnotesize
	\begin{lstlisting}
